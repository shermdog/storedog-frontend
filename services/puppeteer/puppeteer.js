...
const startProtocol = process.env.STOREDOG_PROTOCOL || 'http'
const startHost = process.env.STOREDOG_HOST;
const startPort = process.env.STOREDOG_PORT || 80
const startUrl = startProtocol + '://' + startHost + ':' + startPort
